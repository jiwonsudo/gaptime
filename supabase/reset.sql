...
drop table if exists stat_expected_size cascade;
drop table if exists stat_final_size cascade;
drop table if exists stat_scan_feedback cascade;
drop table if exists stat_scan_diff cascade;
...
drop function if exists _bump_expected_size(int) cascade;
drop function if exists _size_bucket(int) cascade;
drop function if exists _bump_final_size(int) cascade;
drop function if exists submit_scan_feedback(boolean,int) cascade;
