...
// 링크 타고 들어온 멤버 기준 안내 — "내 시간표 올리기" 중심, 참여 링크는 짧게만 소개
const MEMBER_STEPS: TourStep[] = [
  {
    selector: '[data-tour="submit"]',
    title: '내 시간표를 올려요',
    body: '이름(닉네임)을 정하고 에타 시간표 스크린샷을 올린 뒤, 격자를 맞추고 틀린 칸을 손으로 고쳐 제출하면 끝. 이름은 이 방 사람들에게 보여요. 올리고 나면 PIN을 설정해서 나만 수정할 수 있게 할 수도 있어요.',
  },
  {
    selector: '[data-tour="share"]',
    title: '아직 안 올린 사람에게도 링크를 보내주세요',
    body: '여기 “참여 링크 · 방 코드”를 펼치면 이 방 링크와 코드가 나와요. 아직 안 올린 사람에게 전달하면 결과가 더 정확해져요.',
  },
];
