...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: '이름 두 개만 넣으면 끝',
    body: '방 이름과 방장(본인) 이름만 있으면 바로 만들 수 있어요. 시간대·인원 같은 세부 설정은 나중에 바꿔도 돼요.',
  },
  {
  ...
  },
  {
    ...
    title: '방장 PIN은 지금만 걸 수 있어요',
    body: '다른 기기나 브라우저에서 방을 관리(제출 마감·인원 변경·방 삭제)하려면 PIN이 필요해요. 방을 만든 뒤에는 추가할 수 없으니, 필요하면 지금 설정하세요.',
  },
  {
    selector: '[data-tour="advanced-settings"]',
    title: '세부 설정 (선택)',
    body: '토·일 포함 여부, 볼 시간대, 30분 단위, 함께할 인원을 여기서 정해요. 기본값 그대로 둬도 되고, 방 만든 뒤 방장 관리에서 나중에 바꿔도 돼요(제출 전까지).',
    autoExpand: true,
  },
];
